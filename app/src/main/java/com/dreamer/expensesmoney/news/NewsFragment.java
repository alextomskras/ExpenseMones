...
import com.dreamer.expensesmoney.BuildConfig;
import com.dreamer.expensesmoney.R;
import com.dreamer.expensesmoney.news.api.ApiClient;
import com.dreamer.expensesmoney.news.api.ApiInterface;
import com.dreamer.expensesmoney.news.models.Article;
import com.dreamer.expensesmoney.news.models.News;
import com.dreamer.expensesmoney.ui.MainActivity;
...
//берем ключь из настроечного файлика в градле
    public static final String API_KEY= BuildConfig.MY_API_KEY;
//    public static final String API_KEY= "f98a6d49d8ce4c75a0d336126c1562ab";
    ...
    private void initListener(){
        adapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(requireActivity(), "Not Worked", Toast.LENGTH_LONG).show();
