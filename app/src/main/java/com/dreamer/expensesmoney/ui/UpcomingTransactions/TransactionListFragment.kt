package com.dreamer.expensesmoney.ui.UpcomingTransactions
...
import com.dreamer.expensesmoney.R.id.*
import com.dreamer.expensesmoney.ui.TransactionAdapter
            ...
            adapter = TransactionAdapter(
                {
                    findNavController().navigate(
                        TransactionListFragmentDirections.actionTransactionListFragmentToTransactionDetailFragment(it)
                    )
                },
            )
        }
...
// setup Pie chart animations
        ...
        val pieDataSet = PieDataSet(pieEntries, getString(R.string.This_is_Pie_Chart_Label))
        ...
        pieChart.centerText = getString(R.string.text_in_pieChart_centre)
...
//        now hide the description of piechart
        ...
        pieChart.description.text = getString(R.string.text_in_pieChart_centre)
